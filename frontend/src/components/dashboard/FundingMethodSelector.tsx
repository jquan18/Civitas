      ...
      {showLiFi && (
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 text-left">
              <h4 className="font-headline text-xl uppercase mb-2">Cross-Chain Bridge</h4>
              <p className="font-display text-sm text-gray-600 mb-2">
                Bridge from any chain using LI.FI (auto-swap to USDC)
              </p>
              <div className="flex flex-wrap gap-2 text-xs">
                <span className="bg-gray-100 px-2 py-1 border border-black font-mono">✓ From 20+ chains</span>
                <span className="bg-gray-100 px-2 py-1 border border-black font-mono">✓ Auto-swap any token</span>
